    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NEW', 'Новая'), ('IN_WORK', 'В работе'), ('COMPLETED', 'Завершена')], default='NEW', max_length=30)),
                ('priority', models.CharField(choices=[('ZERO', '0'), ('ONE', '1'), ('TWO', '2'), ('THREE', '3'), ('FOUR', '4'), ('FIVE', '5')], default='NULL', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100)),
                ('description', models.TextField()),
                ('status', models.CharField(choices=[('CONSIDERATION', 'Рассмотрение'), ('ACCEPTED', 'Принято'), ('REJECTED', 'Отклонено')], default='CONSIDERATION', max_length=30)),
                ('priority', models.CharField(choices=[('ZERO', '0'), ('ONE', '1'), ('TWO', '2'), ('THREE', '3'), ('FOUR', '4'), ('FIVE', '5')], default='NULL', max_length=5)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
